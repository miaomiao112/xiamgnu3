...
function ShowGoods(json){
	...
	if(typeof this.initUI!="function"){
		ShowGoods.prototype.initUI=function(){
			...
			var str="<div style='border:1px solid #eeeeee;width:"+this.imgWidth+"px;height:"+this.imgHeight+"px;margin-bottom:20px;margin-left:auto;margin-right:auto;position:relative'><img src="+this.imgArr[0]+" style='width:"+this.imgWidth+"px;height:"+this.imgHeight+"px'/>";
			str+="<div style='width:"+this.zoomWidth+"px;height:"+this.zoomHeight+"px;background:rgba(160,160,160,2.5);border:1px solid #000;opacity:.3;cursor:move;position:absolute;top:0;left:0;display:none'></div></div>";
			str+="<div style='border:1px solid #dcdcdc;width:300px;height:300px;margin-left:130px;display:none;position:absolute;top:0;left:"+this.boxWidth+"px;overflow:hidden'><img src="+this.imgArr[0]+" style='position:absolute;width:"+this.imgWidth*this.times+"px;height:"+this.imgHeight*this.times+"px'/></div>";
			...
			str+="</ul>";
			str+="<input type='button' style='position:absolute;cursor:pointer;background:"+this.btnColor+";opacity:.3;border:none;width:"+this.btnWidth+"px;height:"+this.listHeight+"px;top:0;leftpx;color:"+this.btnFontColor+";font-size:"+this.btnFontSize+"px;outline:none' value='\<'/>"
			str+="<input type='button' style='position:absolute;cursor:pointer;background:"+this.btnColor+";opacity:.3;border:none;width:"+this.btnWidth+"px;height:"+this.listHeight+"px;top:0;left:"+((this.listWidth+this.listSpace)*this.listNum-this.listSpace-this.btnWidth)+"px;color:"+this.btnFontColor+";font-size:"+this.btnFontSize+"px;outline:none' value='\>'/>"
			str+="</div>";
...
$(function(){
	new ShowGoods({
		...
		boxHeight:538,
		times:2,
		imgArr:["img-s/1489574912.jpg","img-s/1468234160.jpg","img-s/1477450853.jpg","img-s/1498099744.jpg","img-s/1487737016.jpg"],
		imgWidth:458,
		imgHeight:458,
		zoomColor:'yellow',
		zoomWidth:150,
