...
Slideshow.prototype.initUI = function(){
	...
	//2、所有按钮的创建
	let ulliStr = "<ul style='position:absolute;right:422px;bottom:-177px;z-index:9;display:flex;justify-content:space-between'>";
	
	for(let i=0;i<this.imgs.length;i++){
		ulliStr +="<li ord='"+(i+1)+"' style='list-style:none;float:left;margin:10px;width:"+this.btnWidth+"px;height:"+this.btnHeight+"px;line-height:"+this.btnHeight+"px;border-radius:50%;text-align:center;color:#000;background-color:"+this.btnColor+";'>"+(i+1)+"</li>"
	}
	ulliStr +="</ul>";
